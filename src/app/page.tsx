...
export default function Home() {
  ...
  return <main className="app-shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-footer"><div className="support-icon"><LifeBuoy size={17} /></div><div><b>Central de ajuda</b><small>Fale com o suporte</small></div><ArrowUpRight size={15} /></div><div className="profile"><span className="avatar avatar-ink">CA</span><div><b>Carolina</b><small>Administradora</small></div><MoreHorizontal size={17} /></div>
    </aside>
